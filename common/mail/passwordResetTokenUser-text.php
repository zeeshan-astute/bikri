						...
						<tr>
							<td style="padding: 18px 0 0;" align="left">			
								<h2 style=" font-weight: normal; margin: 0; padding: 0 0 12px; font-style: inherit; line-height: 30px; font-size: 25px; 
									font-family: Trebuchet MS; border-bottom: 1px solid #333333; ">  <?php echo Yii::t('app','Hello')." ".$user->username; ?>, 
							...
							<tr>
								<td style="padding: 15px 0;"  valign="top">
									<p style='margin-bottom: 10px'>
										<?php echo Yii::t('app','Hello'); ?> <?php echo $user->username; ?>,
									</p>
									<p style='margin-bottom: 10px'>
									...
									<p style='margin-bottom: 10px'>
										...
										<a href="<?php echo $resetLink; ?>" title="reset password">
											<?php echo $resetLink; ?>
										</a>
									</p>
									<p style='margin-bottom: 10px'>
