...
<div class="admin-form">
 <?php $form = ActiveForm::begin(['options' =>['class' => 'boxShadow p-3 bgWhite m-b20']]); ?>
    <h4 class="m-b25  blueTxtClr p-t10 p-b10"> <?php echo Yii::t('app','Add').' '.Yii::t('app','Moderator'); ?></h4>
<p class="note">
...
<?=  $form->field($model, 'password')->passwordInput(['maxlength' => true, 'id'=>'Users_password'])->label(false) ?>
