...
<div class="boxShadow p-t20 p-b20 p-l15 p-r10 bgWhite m-b20">
  ...
  <div class="d-flex justify-content-between  flex-column flex-sm-row">
    <div>
      <h4 class="m-b25 blueTxtClr p-t10 p-b10"><?php echo Yii::t('app','New Arrivals')?></h4>
    </div>
    <div class="">
      <?php 
      echo Html::a(Yii::t('app','Approved'),['banners/bannerlist'],array('class' => "btn btn-sm btn-default pull-right custom-class btn-primary",'style'=>"cursor: pointer; font-size: 12px; line-height: 16px;margin-left:5px;")
    ).'&nbsp;'; 
      ...
      echo Html::a(Yii::t('app','New Banners'), ['banners/paidbanner'],array('class' => "btn btn-sm btn-default pull-right custom-class btn-success",'style'=>"cursor: pointer; font-size: 12px; line-height: 16px; margin-left:5px;")).'&nbsp;';
      ...
      'columns' => [
        ...
        [
          ...
          'content' => function($model) {
            ...
            'format' => 'html',
            'value' => function($model) {     
              return strtok($model->startdate, 'T');
            } ,
          ],
          [
            'attribute' => 'enddate',
            ...
            'content' => function($model) {
              ...
              [
                ...
                'content' => function($model) {
                  return Html::a(Yii::t('app','Accept'), ['banners/accept', 'id'=>$model->id],array('class' => "callMobilePayment btn btn-primary"));
                } 
              ],
              [
                'header'=>Yii::t('app','Decline'),
                'content' => function($model) {
                  return Html::a(Yii::t('app','Refund'), ['banners/refund', 'id'=>$model->id],array('class' => "callMobilePayment btn btn-danger"));
                } 
              ],
              [
