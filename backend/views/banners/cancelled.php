...
<div class="boxShadow p-t20 p-b20 p-l15 p-r10 bgWhite m-b20">
       ...
       <div class="d-flex justify-content-between  flex-column flex-sm-row">
            <div>
                <h4 class="m-b25 blueTxtClr p-t10 p-b10"><?php echo Yii::t('app','Rejected Banners')?></h4>
            </div>
            <div class="">
                    <?php 
                            ...
                            echo Html::a(Yii::t('app','Rejected'),['banners/cancelled'],array('class' => "btn btn-sm btn-default pull-right custom-class btn-success",'style'=>"cursor: pointer; font-size: 12px; line-height: 16px;margin-left:5px; ")
                            ).'&nbsp;';
