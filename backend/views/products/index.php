            ...
            <div class="materialTab m-b25">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item selected m-t15">
                            <a class="nav-link active" id="home-tab" href="javascript:void(0);"><?php echo Yii::t('app','Approved Items');?></a>
                        </li>
                        <li class="nav-item m-t15">
                            <a class="nav-link" id="profile-tab" href="<?php echo Yii::$app->homeUrl."products/pending" ?>"
